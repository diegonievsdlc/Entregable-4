...
function App() {
  ...
  return (
    <div className="App">
      <nav>
        <h1>Usuarios</h1>
        <button onClick={showAndHideModal}><i className='bx bx-plus'></i> Crear nuevo usuario</button>
      </nav>
      <UsersList users={users} removeUser={removeUser} selectUser={selectUser}/>
      {
        modalForm && <UsersForm 
                        getUsers={getUsers} 
        ...
        modalRemove && (
          <div className="modal">
            <div className="modal-remove">
              ...
              <p>El usuario {userDeleted} se ha eliminado</p>
              <button 
